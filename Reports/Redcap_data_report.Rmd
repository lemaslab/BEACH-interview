...
#Filler_date <- seq(min("2017-09"), max("2019-04"))


    #testing to add missing dates
#ts <- seq.POSIXt(as.POSIXct("2018-01-01 0:00",'%y/%m/%d #%H:%M'), as.POSIXct("2019-04-01 0:0",'%y/%m/%d %H:%M'), #by="min")
#
#ts <- format.POSIXct(ts,'%y/%m/%d %H:%M')
#
#df <- data.frame(timestamp=ts)
#
#data_with_missing_times <- full_join(df,Encounter_per_Time, #by="YM")
#
